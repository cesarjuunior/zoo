...
public interface AnimaisRepository extends JpaRepository<Animais, Long> {
    ...
    @Query(value = "select a.nome, a.especie, a.altura, a.peso, al.nome as alimentoNome, c.tipo, cl.nome_da_classe, r.nome as responsavelNome, a.id  from zoo.animais as a " +
